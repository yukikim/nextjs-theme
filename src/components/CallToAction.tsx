      ...
      <Container>
        <div className="relative">
          <div className="flex items-center justify-center -space-x-2">
            <Image width={32} height={32} src="/images/avatars/avatar.webp" alt="member" className="h-8 w-8 rounded-full object-cover" />
            <Image width={48} height={48} src="/images/avatars/avatar-2.webp" alt="member" className="h-12 w-12 rounded-full object-cover" />
            <Image width={64} height={64} src="/images/avatars/avatar-3.webp" alt="member" className="z-10 h-16 w-16 rounded-full object-cover" />
            <Image width={48} height={48} src="/images/avatars/avatar-4.webp" alt="member" className="relative h-12 w-12 rounded-full object-cover" />
            <Image width={32} height={32} src="/images/avatars/avatar-1.webp" alt="member" className="h-8 w-8 rounded-full object-cover" />
          </div>
          <div className="mt-6 m-auto space-y-6 md:w-8/12 lg:w-7/12">
            <h1 className="text-center text-4xl font-bold text-gray-800 dark:text-white md:text-5xl">Get Started now</h1>
            <p className="text-center text-xl text-gray-600 dark:text-gray-300">Be part of millions people around the world using tailus in modern User Interfaces.</p>
